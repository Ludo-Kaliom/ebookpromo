 ...
 */
final class Version20220207090024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, type_id INT NOT NULL, title VARCHAR(255) NOT NULL, isbn VARCHAR(13) NOT NULL, description LONGTEXT NOT NULL, cover VARCHAR(255) NOT NULL, normalprice DOUBLE PRECISION NOT NULL, reduceprice DOUBLE PRECISION NOT NULL, startdate DATETIME NOT NULL, enddate DATETIME NOT NULL, link VARCHAR(255) NOT NULL, status TINYINT(1) DEFAULT NULL, publisher VARCHAR(255) NOT NULL, authors VARCHAR(255) NOT NULL, INDEX IDX_CBE5A331A76ED395 (user_id), INDEX IDX_CBE5A331C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
